<!-- Modal -->
<div class="modal fade" id="btn-new-book" tabindex="-1" role="dialog" aria-labelledby="btn-new-bookLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{ route('books.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-header p-3 border-bottom-0">
                    <h5 class="modal-title" id="btn-new-bookLabel">Create Books</h5>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('title') is-invalid @enderror"
                                    placeholder="Insert Book Name" type="text" name="title" id="title" required
                                    value="{{ old('title') }}" />
                                @error('title')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('cover') is-invalid @enderror" type="file"
                                    name="cover" id="cover" required value="{{ old('cover') }}" />
                                @error('cover')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('file_pdf') is-invalid @enderror" type="file"
                                    name="file_pdf" id="file_pdf" required value="{{ old('file_pdf') }}" />
                                @error('file_pdf')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('isbn') is-invalid @enderror"
                                    placeholder="Insert Number ISBN" type="text" name="isbn" id="isbn"
                                    value="{{ old('isbn') }}" />
                                @error('isbn')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('google') is-invalid @enderror"
                                    placeholder="Insert Link Google Books" type="text" name="google" id="goolge"
                                    value="{{ old('google') }}" />
                                @error('google')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('halaman') is-invalid @enderror"
                                    placeholder="Insert Book Pages" type="text" name="halaman" id="halaman"
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('publish_date') is-invalid @enderror" type="date"
                                    name="publish_date" id="publish_date" required value="{{ old('publish_date') }}" />
                                @error('publish_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input class="form-control  @error('author') is-invalid @enderror"
                                    placeholder="Insert Autor Name (,)" type="text" name="author" id="author"
