            ...
            <div class="col-lg-10">
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex align-items-center">
                        <h4 class="header-title">Pages Edit</h4>
                        <a href="{{ route('pages.index') }}" class="ms-auto">
                            ...
                            <div class="row">
                                <div class="col-lg-6 sm-12 mb-3">
                                    ...
                                    <select class="form-select" data-toggle="select2" name="type" id="type">
                                        ...
                                        <option value="About" @if ($page->type == 'About') selected @endif>About
                                        </option>
                                        <option value="Program" @if ($page->type == 'Program') selected @endif>Program
                                        </option>
                                        <option value="Services" @if ($page->type == 'Services') selected @endif>Services
                                        </option>
                                    </select>
                                    {{-- error --}}
                                    @if ($errors->has('type'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 sm-12 mb-3">
                                    ...
                                    <select class="form-select" name="is_active" id="is_active">
                                        ...
                                        <option value="0" @if ($page->is_active == '0') selected @endif>Off
                                        </option>
                                    </select>
                                    {{-- error --}}
