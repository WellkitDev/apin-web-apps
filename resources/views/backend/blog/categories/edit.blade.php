        ...
        <div class="page-title-box">
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="font-18 mb-0">Category {{ $categories->category_name }}</h4>
                </div>
                <div class="text-end">
            ...
            <div class="col-lg-6 col-xl-6 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <form action="{{ route('category.update', ['slug' => $categories->category_slug]) }}"
                                ...
                                <div class="col-lg-6 sm-12 mb-2">
                                    ...
                                    <div class="col-lg-12 sm-12">
                                        <select class="form-select" name="is_active" id="is_active">
                                            <option value="0"@if ($categories->show_on_menu == 0) selected @endif>On
                                            </option>
                                            <option value="1"@if ($categories->show_on_menu == 1) selected @endif>Off
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 sm-12 mb-2">
                                    ...
                                    <div class="col-lg-12 sm-12">
                                        <input type="text" class="form-control" id="order" name="order"
                                            value="{{ $categories->category_order }}">
                                    </div>
                                    @if ($errors->has('order'))
