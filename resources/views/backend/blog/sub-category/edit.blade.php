        ...
        <div class="page-title-box">
            <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                <div class="flex-grow-1">
                    <h4 class="font-18 mb-0">SubCategories Blog</h4>
                </div>
                <div class="text-end">
            ...
            <div class="col-lg-6 col-xl-6 col-sm-12">
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex align-items-center">
                        <h4 class="header-title">Sub Category Create</h4>
                        <a href="{{ route('subcategory.index') }}" class="ms-auto">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <form action="{{ route('subcategory.update', ['slug' => $subCategory->slug_sub]) }}"
                                    ...
                                    <div class="col-lg-12 sm-12">
                                        <select class="form-select" data-toggle="select2" name="category_name"
                                            ...
                                            @foreach ($categories as $item)
                                                <option
                                                    value="{{ $item->id }}"@if ($subCategory->categore_id == $item->id) selected @endif>
                                ...
                                <div class="col-lg-6 sm-12 mb-2">
                                    <div class="col-lg-12">
                                        <label for="sub_title" class="form-label">Category Name: </label>
                                    </div>
                                    <div class="col-lg-12 sm-12">
                                ...
                                <div class="col-lg-6 sm-12 mb-2">
                                    ...
                                    <div class="col-lg-12 sm-12">
                                        <select class="form-select" name="is_active" id="is_active">
                                            <option value="0"@if ($subCategory->show_on_menu == 0) selected @endif>On
                                            </option>
                                            <option value="1"@if ($subCategory->show_on_menu == 1) selected @endif>Off
                                            </option>
                                        </select>
                                    </div>
