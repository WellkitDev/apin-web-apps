            ...
            <div class="col-lg-6 col-xl-6 col-sm-12">
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex align-items-center">
                        <h4 class="header-title">Article Create</h4>
                            ...
                            <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6 sm-12 mb-2">
                                        ...
                                        <div class="col-lg-12 sm-12">
                                            <input type="text" class="form-control" id="title" name="title"
                                                placeholder="Pedoman Pembuatan Artikel">
                                        </div>
                                        @if ($errors->has('title'))
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-6 sm-12 mb-2">
                                        ...
                                        <div class="col-lg-12 sm-12">
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control js-example-basic-multiple"
                                                    id="article_tags" name="article_tags" multiple="multiple"
                                                    placeholder="class, scholar, pen">
                                            </div>
                                        </div>
