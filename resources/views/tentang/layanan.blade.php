            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="wpo-service-item">
                        ...
                        <div class="wpo-service-text">
                            <h2><a href="{{ '/tentang/layanan/detail' }}">Strategy and Planning</a></h2>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="wpo-service-item">
                        ...
                        <div class="wpo-service-text">
                            <h2><a href="{{ '/tentang/layanan/detail' }}">Corporate Finance</a></h2>
                            <p>One way to categorize the activities is in terms of the professional’s area of expertise such
                                as competitive analysis, corporate strategy.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="wpo-service-item">
                        ...
                        <div class="wpo-service-text">
                            <h2><a href="{{ '/tentang/layanan/detail' }}">Market Research</a></h2>
                            <p>One way to categorize the activities is in terms of the professional’s area of expertise such
                                as competitive analysis, corporate strategy.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="wpo-service-item">
                        ...
                        <div class="wpo-service-text">
                            <h2><a href="{{ '/tentang/layanan/detail' }}">Business Analysis</a></h2>
                            <p>One way to categorize the activities is in terms of the professional’s area of expertise such
                                as competitive analysis, corporate strategy.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="wpo-service-item">
                        ...
                        <div class="wpo-service-text">
                            <h2><a href="{{ '/tentang/layanan/detail' }}">Consumer Markets</a></h2>
                            <p>One way to categorize the activities is in terms of the professional’s area of expertise such
                                as competitive analysis, corporate strategy.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="wpo-service-item">
                        ...
                        <div class="wpo-service-text">
                            <h2><a href="{{ '/tentang/layanan/detail' }}">Insurance</a></h2>
                            <p>One way to categorize the activities is in terms of the professional’s area of expertise such
                                as competitive analysis, corporate strategy.</p>
                        </div>
                    </div>
